...
<script type="text/javascript">
	...
	function openGradeAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加网点信息");
		url="gradeSave";
	}
	...
	function openGradeModifyDialog(){
		...
		$("#dlg").dialog("open").dialog("setTitle","编辑网点信息");
		$("#fm").form("load",row);
...
<body style="margin: 5px;">
	<table id="dg" title="网点信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="gradeList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="id" width="50">编号</th>
				<th field="gradeName" width="100">网点名称</th>
				<th field="gradeDesc" width="250">网点描述</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>&nbsp;网点名称：&nbsp;<input type="text" name="s_gradeName" id="s_gradeName"/><a href="javascript:searchGrade()" class="easyui-linkbutton" iconCls="icon-search" plain="true">搜索</a></div>
	</div>
