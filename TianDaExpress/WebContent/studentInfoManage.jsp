...
<body style="margin: 5px;">
	 ...
	 pagination="true" rownumbers="true" url="studentList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="gradeId" width="100" align="center" hidden="true">网点ID</th>
				<th field="gradeName" width="100" align="center">网点名称</th>
				<th field="email" width="150" align="center">Email</th>
				<th field="stuDesc" width="250" align="center">用户备注</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		...
		<div>&nbsp;工号：&nbsp;<input type="text" name="s_stuNo" id="s_stuNo" size="10"/>
		...
		&nbsp;所属网点：&nbsp;<input class="easyui-combobox" id="s_gradeId" name="s_gradeId" size="10" data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'gradeName',url:'gradeComboList'"/>
